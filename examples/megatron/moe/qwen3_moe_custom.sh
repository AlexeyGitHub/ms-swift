...
megatron sft \
    ...
    --min_lr 1e-6 \
    --save /mnt/filesystem-n3/khoroshilov/train/other_train/ms-swift/megatron_output/qwen3-coder-30b-a3b-instruct-v2 \
    --eval_interval 100 \
    --save_interval 100 \
    --max_length 8192 \
    --num_workers 8 \
    ...
    --wandb_exp_name qwen3-coder-30b-a3b-instruct-SFT-v2 \
